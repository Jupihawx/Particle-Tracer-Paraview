...
name="PointSourceGenerated{0}"


FieldSource = FindSource('ProgrammableFilter1')
particleSource = FindSource('LiveProgrammableSource{0}')
...
particleTracerGenerated = ParticleTracer(registrationName='ParticleTracerGenerated{0}', Input=FieldSource,
